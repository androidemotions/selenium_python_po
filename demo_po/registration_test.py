...
def test_registration(driver):
    ...
    driver.get("http://localhost:4040/litecart/admin/")
    driver.find_element_by_name("username").send_keys("admin")
    driver.find_element_by_name("password").send_keys("admin")
    driver.find_element_by_name("login").click()
    driver.get("http://localhost:4040/litecart/admin/?app=customers&doc=customers")
    ...
    driver.get("http://localhost:4040/litecart/en/create_account")
