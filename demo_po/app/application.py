...
from demo_po.pages.admin_panel_login_page import AdminPanelLoginPage
from demo_po.pages.customer_list_page import CustomerListPage
from demo_po.pages.registration_page import RegistrationPage
...
class Application:
    ...
    def __init__(self):
        ...
        self.base_url = "http://localhost:4040/litecart"
